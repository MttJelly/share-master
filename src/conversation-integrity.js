...
const INTERRUPTED_TOOL_OUTPUT = "Tool execution was interrupted before Share Master recorded a result. Treat this call as cancelled and do not infer that it succeeded.";
